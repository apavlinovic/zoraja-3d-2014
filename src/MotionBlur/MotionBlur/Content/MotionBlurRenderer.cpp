...
MotionBlurRenderer::MotionBlurRenderer(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
void MotionBlurRenderer::CreateWindowSizeDependentResources()
{
	...
	static const XMVECTORF32 eye = { 1.0f, -0.7f, 3.5f, 0.0f };
...
void MotionBlurRenderer::Update(DX::StepTimer const& timer)
{
...
void MotionBlurRenderer::Rotate(float radians)
{
	XMStoreFloat4x4(&m_constantBufferData.model, 
		XMMatrixTranspose(XMMatrixRotationY(radians)));
}

void MotionBlurRenderer::SetRotationSpeed(float degreesPerSecond)
{
	m_degreesPerSecond += degreesPerSecond;
}

void MotionBlurRenderer::Render()
{
...
void MotionBlurRenderer::CreateDeviceDependentResources()
{
...
void MotionBlurRenderer::ReleaseDeviceDependentResources()
{
	m_loadingComplete = false;
